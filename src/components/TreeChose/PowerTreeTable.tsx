...
import { IPower, IPowerTree } from '@/models/index.type';
  ...
  const tableColumns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        key: 'powers',
        width: '70%',
        render: (value: IPower[], record: PowerLevel): JSX.Element[] | null => {
          if (value) {
