              ...
              return (
                <>
                  <Switch>
                    ...
                    <Route exact path="/home" render={props => handleEnter(Home, props)} />
                    {/*<Route*/}
                    {/*  path="/features"*/}
                    {/*  render={(props) => handleEnter(Features, props)}*/}
                    {/*/>*/}
                    {/*<Route*/}
                    {/*  path="/test"*/}
                    {/*  render={(props) => handleEnter(Test, props)}*/}
                    {/*/>*/}
                    {/*<Route*/}
                    {/*  path="/testclass"*/}
                    {/*  render={(props) => handleEnter(TestClass, props)}*/}
                    {/*/>*/}
